...
(function (arrOfTasks) {
    ...
    listContainer.addEventListener('click', onDeleteHandker);
    ...
    function onThemeSelectHandler(e) {
        ...
        const isConfirmed = confirm(`Do you really want to change the theme: ${selectedTheme}`);
        if (!isConfirmed) {
            themeSelect.value = lastSelectedTheme;
            return;
        }
        setTheme(selectedTheme);
        lastSelectedTheme = themeSelect;
    }
